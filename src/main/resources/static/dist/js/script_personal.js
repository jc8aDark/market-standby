...
function addProduct() {
    ...
    var quantity = parseInt(quantityInput.value) || 0; // Asegurar que la cantidad sea un número entero
    ...
    if (selectedProductOption) {
        var product = {
            ...
            quantity: quantity, // Utilizar la cantidad obtenida del input
            price: parseFloat(selectedProductOption.getAttribute('data-price')) || 0, // Convertir el precio a un número flotante
            user: userName
        };
        ...
        cellPrice.innerHTML = product.price.toFixed(2); // Mostrar el precio con dos decimales
        cellSubtotal.innerHTML = subtotal.toFixed(2);  // Mostrar el subtotal con dos decimales
